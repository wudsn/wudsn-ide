...
final class ImageConverterDataView {
	...
	public ImageConverterDataView(GraphicsConversionEditor editor, Composite parent,
		...
		imageFilePathField = new FilePathField(topComposite, Texts.CONVERTER_PARAMETERS_IMAGE_FILE_PATH_LABEL,
				SWT.OPEN);
		...
		imageDataHeightField = new IntegerField(topComposite, Texts.CONVERTER_DATA_IMAGE_DATA_HEIGHT_LABEL, null, false,
				NumberUtility.AUTOMATIC_LENGTH, SWT.READ_ONLY);
