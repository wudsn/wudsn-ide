...
final class FilesConverterDataView {
	...
	public FilesConverterDataView(final GraphicsConversionEditor editor, Composite parent,
		...
		spacingWidthField = new IntegerField(composite, Texts.CONVERTER_PARAMETERS_SPACING_WIDTH_LABEL,
				new int[] { 0, 1, 2, 4, 8 }, false, NumberUtility.AUTOMATIC_LENGTH, SWT.NONE);
		...
		columnsField = new IntegerField(composite, Texts.CONVERTER_PARAMETERS_COLUMNS_LABEL,
				new int[] { 1, 2, 3, 4, 8, 16, 32, 40, 48, 64, 128, 256 }, false, NumberUtility.AUTOMATIC_LENGTH,
				SWT.NONE);
		...
		rowsField = new IntegerField(composite, Texts.CONVERTER_PARAMETERS_ROWS_LABEL, new int[] { 1, 2, 3, 4, 24, 25 },
				false, NumberUtility.AUTOMATIC_LENGTH, SWT.NONE);
