...
public final class ImageConverterParameters extends ConverterCommonParameters {
	 ...
	 * 
	 * @param value <code>true</code> to use the default script, <code>false</code>
	 ...
	 * 
	 * @return <code>true</code> to use the default script, <code>false</code> to
	 ...
	 * 
	 * @param value The script, may be empty, not <code>null</code>.
	 */
