...
public abstract class Converter {
	...
	/**
	 * Constants for 1 bit pixels. Constants are defined as int to ensure no sign
	 ...
	 * only.
	 * 
	 * @param definition The definition if the Converter, not <code>null</code>.
	 */
	 ...
	 * 
	 * @param data  The file converter data container to be filled, not
	 *              <code>null</code>.
	 * @param bytes The byte array, not empty and not <code>null</code>.
	 * 
	 * @since 1.6.0
	...
	/**
	 * Sets the current converter, applies its defaults and then sets the image size
	 * and palette.
	 * 
	 * @param data          The file converter data container to be filled, not
	 *                      <code>null</code>.
	 ...
	 * @param palette       The palette, not <code>null</code>.
	 * @param paletteColors The palette colors or not <code>null</code> if palette
	 *                      is {@link Palette#TRUE_COLOR}.
	 */
	 ...
	 * 
	 * @param data The data, not <code>null</code>.
