...
public final class ImageColorHistogram {
	 ...
	 * 
	 * @param imageData The image data or <code>null</code>.
	 */
	 ...
	 * 
	 * @return The number of bits used for representing pixels or <code>0</code> if
	 *         there is no image.
	 */
	...
	/**
	 * Gets the total number of pixels in the image data. It corresponds to the sum
	 * of count returned by {@link #getPixelColorCount(Integer)}.
	 * 
	...
	/**
	 * Gets the list of all pixel colors in the palette if the palette is an indexed
	 * palette. If the palette is not indexed, the result is an empty list.
	 * 
	 * @return The unmodifiable list of pixel colors, sorted by their pixel value,
	...
	/**
	 * Gets the list of used pixel colors in the image data, sorted by their pixel
	 * value. This method work the same way for direct and indexed palettes.
	 * 
	 * @return The unmodifiable list of pixel colors, sorted by their pixel value,
	 *         may be empty, not <code>null</code>.
	 */
	 ...
	 * 
	 * @param pixelColor The pixel color, not <code>null</code>.
	 * @return The count or <code>0</code> in case the pixel color is not contained
	 *         in the image.
	 */
