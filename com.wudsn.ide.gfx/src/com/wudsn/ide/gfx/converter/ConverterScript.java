...
public final class ConverterScript {
		...
		try {
			...
			if (functionObject == null) {
				throw new CoreException(
						new Status(IStatus.ERROR, GraphicsPlugin.ID, "'" + functionName + "' is undefined."));
			}
			if (!(functionObject instanceof Function)) {
				throw new CoreException(
						new Status(IStatus.ERROR, GraphicsPlugin.ID, "'" + functionName + "' is not a function."));
			}
			...
			throw new CoreException(new Status(IStatus.ERROR, GraphicsPlugin.ID,
					"Error in script line " + ex.lineNumber() + ": " + message + " " + lineSource, ex));
	 ...
	 * 
	 * @param string The string, or <code>null</code>.
	 ...
	 * 
	 * @param converterClass The of the converter, not <code>null</code>.
	 * @return The script for the converter, may be empty, not <code>null</code> .
	 * @throws CoreException In case there is an error while reading an existing
	 *                       script.
	 */
