...
/**
 * This class is based on the excellent open source "First Atari Image Library
 * (FAIL)". Thanks to the creators to FAIL: Piotr Fusik, Adrian Matoga and Pawel
 * Szewczyk for their support. You can find FAIL on sourceforge
...
public final class FilesConverterDataLogic {
	...
	/**
	 * Helper class to detect the support binary file formats by their extension.
	 * The extension have to be defined with lower case characters.
	 * 
	 * @author Peter Dell
	 */
	 ...
	 * dimensions and colors based on the input file. In case of compressed images,
	 * the source file in the data container is replaced by the unpacked content.
	 * This leads to unwanted effect during reload which can only be removed by the
	 * introduction of separate converters for these cases.
	 * 
	 * @param data          The file converter data, not <code>null</code>.
	 * @param bytes         The file content of the input file, not
	 *                      <code>null</code>.
	 * @param fileExtension The file extension of the input file, may be empty, not
	 *                      <code>null</code>.
	 */
