...
public final class InverseBlockList {
	 ...
	 * 
	 * @param column1           Start column, a non-negative integer
	 * @param column2           End column, a non-negative integer
	 * @param row1              Start row, a non-negative integer
	 * @param row2              End row, a non-negative integer
	 * @param inverseColor      The pixel color value which shall be used as inverse
	 *                          color
	 * @param inverseIfConflict <code>true</code> if the inverse color shall also be
	 *                          used in case of conflict
	 */
	 ...
	 * @param row    The column, a non-negative integer.
	 * @return The first matching inverse block, or <code>null</code> if no inverse
	 *         block matches.
	 */
