...
public final class C64Utility {
	 ...
	 * @return <code>true</code> if the byte array represents a valid C64 charset,
	 ...
	 * 
	 * @param bytes The byte array, may be empty, not <code>null</code>.
	 * @return <code>true</code> if the byte array represents a valid C64 sprite (or
	 *         many), <code>false</code> otherwise.
	 * 
	 * @since 1.6.0
	 */
