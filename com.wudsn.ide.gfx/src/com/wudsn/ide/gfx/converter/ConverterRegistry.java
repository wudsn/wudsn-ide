...
public final class ConverterRegistry {
		...
		for (IExtension extension : extensions) {
			...
			for (IConfigurationElement converterGroupElement : converterGroupElements) {
				...
				for (IConfigurationElement converterElement : converterElements) {
					...
					converterDefinition.setTargetImagePaletteSize(
							Integer.parseInt(converterElement.getAttribute("targetImagePaletteSize")));
					converterDefinition.setTargetImageDisplayAspect(
							AspectUtility.fromString(converterElement.getAttribute("targetImageDisplayAspect")));
	 ...
	 * 
	 * @param converterDefinition  The converter definition, not <code>null</code>.
	 */
	 ...
	 * 
	 * @param converterDirection The converter direction, not <code>null</code>.
	 * 
	 * @return The unmodifiable list of converter definitions, sorted by their id,
	 ...
	 * 
	 * @param converterId        The converter id, may be empty, not
	 *                           <code>null</code>.
	 * @param converterDirection The direction of the converter, not
	 *                           <code>null</code>.
	 * 
	 ...
	 * 
	 * @param converterId The converter id, not <code>null</code>.
	 * 
