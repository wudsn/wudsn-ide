...
public final class ImageConverterData extends ConverterCommonData {
	...
	/**
	 * Gets the pixel color value for a given position. There must be an instance of
	 * image data set.
	 * 
	 * @param x The x position, a non-negative integer.
	 * @param y The y position, a non-negative integer.
	 * 
	 * @return The pixel color value.
	 * 
	 * @throws NullPointerException if there is no image data at all.
	 */
	...
	/**
	 * Gets the pixel RGB value for a given position. There must be an instance of
	 * image data set.
	 * 
	 * @param x The x position, a non-negative integer.
	 * @param y The y position, a non-negative integer.
	...
	/**
	 * Sets the target image data, i.e. the image data after converting it to files
	 * and back.
	 * 
	 * @param targetImageData The target image data or <code>null</code>.
	 */
	...
	/**
	 * Gets the target image data, i.e. the image data after converting is to files
	 * and back.
	 * 
	 ...
	 * 
	 * @param targetFileId The target field id, a non-negative integer.
	 * @param scriptBytes  The bytes, may be empty or <code>null</code>.
	 */
	 ...
	 * 
	 * @param targetFileId The target field id, a non-negative integer.
	 * @param bytes        The bytes, may be empty or <code>null</code>.
	 */
	public void setTargetFileBytes(int targetFileId, byte[] bytes) {
		if (targetFileId < 0) {
			throw new IllegalArgumentException(
					"Parameter 'targetFileId' must not be negative. Specified value is " + targetFileId + ".");
		}
