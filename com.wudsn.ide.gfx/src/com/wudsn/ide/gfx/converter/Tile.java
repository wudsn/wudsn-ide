...
public final class Tile {
	 ...
	 * 
	 * @param x The relative x position in the tile, a non-negative integer.
	 * @param y The relative x position in the tile, a non-negative integer.
	 ...
	 * 
	 * @param ignoredPixelColors The array of colors to be ignored during counting
	 *                           or <code>null</code>.
	...
	/**
	 * Counts the map of distinct colors used and their count in a specific line of
	 * the tile.
	 * 
	 * @param y                  The line of the tile, a non-negative integer.
	 * @param ignoredPixelColors The list of colors to be ignored during counting or
	 *                           <code>null</code>.
	 * @return The map of distinct colors used and their count, not
	 *         <code>null</code>.
	 */
