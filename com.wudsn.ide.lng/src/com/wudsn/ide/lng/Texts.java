...
public final class Texts extends NLS {
	...
	public static String TOC_COMPILER_DEFAULT_PATHS_OS_LABEL;
	public static String TOC_COMPILER_DEFAULT_PATHS_ARCHITECTURE_LABEL;
	public static String TOC_COMPILER_DEFAULT_PATHS_ABSOULTE_PATH_LABEL;
	public static String TOC_COMPILER_DEFAULT_PATHS_FILE_PRESENT_LABEL;
	public static String TOC_COMPILER_DEFAULT_PATHS_FILE_PRESENT_YES_LABEL;
	public static String TOC_COMPILER_DEFAULT_PATHS_FILE_PRESENT_NO_LABEL;
