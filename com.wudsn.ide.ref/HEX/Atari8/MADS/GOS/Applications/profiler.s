...
@
	...
	sta ptr4+1
	dey
	lda (ptr2),y ; get lsb of ID
	sta ptr4
	sec
	ror SelectionFlag
	
BuildList	
	mwa #SampleBuffer ptr1 ; source data
	mwa #List2Data ptr2 ; list pointers
	mwa #List2DataBuffer ptr3 ; strings
...
@
	...
	lda ptr3 ; get pointer to string
...
BuildList
	mwa #SampleBuffer ptr1 ; source data
	mwa #List1Data ptr2 ; list pointers
	mwa #List1DataBuffer ptr3 ; strings
	mva #0 Temp1 ; number of items
Loop1
	ldy #0
	lda (ptr1),y
...
List1Data ; list row data records start here
	.ds 16*12 ; max sixteen processes, each with 5 columns plus 2 byte row header
