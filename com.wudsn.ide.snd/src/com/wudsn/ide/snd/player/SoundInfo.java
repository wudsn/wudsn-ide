...
public interface SoundInfo {
     ...
     * 
     * @return The file type , may be empty, not <code>null</code>. The value is
     *         in upper case letter without a leading dot.
     */
     ...
     * 
     * @return <code>0</code> if undefined, <code>1</code> if mono,
     *         <code>2</code> if stereo.
     */
     ...
     * 
     * @return <code>0</code> if no module is loaded, a positive integer if a
     *         module is loaded.
     */
    public int getSongs();
     ...
     * 
     * @param song
     *            The song number, a non-negative number starting at 0.
     * 
    ...
    /**
     * Gets the player rate in Hertz based on the player clock (PAL/NTSC) and
     * the player scan line rate.
     * 
