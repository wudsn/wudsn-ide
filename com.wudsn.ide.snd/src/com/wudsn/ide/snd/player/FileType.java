...
public enum FileType {
    ...
    CM3(".cm3"), CMC(".cmc"), CMR(".cmr"), CMS(".cms"), DLT(".dlt"), DMC(".dmc"), FC(".fc"), MPD(".mpd"), MPT(".mpt"), RMT(
	    ".rmt"), SAP(".sap"), TM2(".tm2"), TM8(".tm8"), TMC(".tmc"), XEX(".xex"),
     ...
     * 
     * @param extension
     *            the extension, lower case with a leading dot, not
     *            <code>null</code>.
     * @return The file type, or <code>null</code> if not matching file type
     *         exists.
     */
