...
public final class RunnerRegistry {
     ...
     * 
     * @param hardware
     *            The hardware used for filtering, not <code>null</code>.
     * 
     * @return The unmodifiable list of runner definitions which have the
     *         matching hardware or {@link Hardware#GENERIC}, sorted by their
    ...
    /**
     * Gets the runner for a given id. Instances of runner are stateless
     * singletons within the plugin.
     * 
     * @param hardware
     *            The hardware, not <code>null</code>.
     * @param runnerId
     *            The runner type, see {@link RunnerId}, not <code>null</code>.
     * 
