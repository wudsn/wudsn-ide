...
public final class RunnerDefinition implements Comparable<RunnerDefinition> {
    ...
    /**
     * Sets the id of the runner. Called by {@link RunnerRegistry} only. The id
     * is only unique together with the hardware returned by
     * {@link #getHardware()}.
     * 
     * @param id
     *            The id of the runner, not empty and not <code>null</code>.
     */
     ...
     * 
     * @param name
     *            The name of the runner, not empty and not <code>null</code>.
     */
    ...
    /**
     * Determines if the runner allows a runner executable path to be
     * configured.
     * 
     * @return <code>true</code> if the runner allows a runner executable path
     *         to be configured, <code>false</code> otherwise.
     */
    ...
    /**
     * Sets the absolute URL of the home page where the runner can be
     * downloaded. Called by {@link RunnerRegistry} only.
     * 
     * @param homePageURL
     *            The absolute URL of the home page where the runner can be
    ...
    /**
     * Gets the absolute URL of the home page where the runner can be
     * downloaded.
     * 
     * @return The absolute URL of the home page where the runner can be
     *         downloaded. The result may be empty, not <code>null</code>.
     */
    ...
    /**
     * Sets the runner default command line. Called by {@link RunnerRegistry}
     * only.
     * 
     * @param defaultCommandLine
     *            The runner default parameters, may be empty or
     *            <code>null</code>.
     */
     ...
     * 
     * @param o
     *            The object to compare this one with, not <code>null</code>.
     */
    @Override
