...
public final class CompilerSyntax {
     ...
     * 
     * @param compilerId
     *            The compiler id, not empty and <code>null</code>.
     */
     ...
     *            loaded, not empty and not <code>null</code>. The content of
     ...
     *         comments, not empty and not <code>null</code>.
     */
     ...
     * 
     * @return The unmodifiable list of delimiter prefixes for single line
     *         comments, not empty and not <code>null</code>. The list contains
     ...
     *         specified CPU, not <code>null</code>.
     * 
     * @since 1.6.1
     */
