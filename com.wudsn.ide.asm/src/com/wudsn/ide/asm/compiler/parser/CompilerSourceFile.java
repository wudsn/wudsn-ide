...
public final class CompilerSourceFile {
     ...
     *            relative file paths, or <code>null</code> if the document is
     *            not yet persistent.
     * @param document
     ...
     * 
     * @return The file where the document is located, or <code>null</code> if
     ...
     * @param forSection
     *            <code>true</code> if the folding is started for a section,
     *            <code>false</code> if not.
     */
     ...
     *            The start offset, a non-negative integer.
     * @param section
     *            The new section, not <code>null</code>.
     * @param withFolding
     ...
     *         label, may be empty, not <code>null</code>. The result may
