...
public final class CompilerSourceParserFileReference {
	 ...
	 * 
	 * @param type The type of the include, see
	...
	/**
	 * Sets the include directive end offset. The value must be the offset of first
	 * character after the directive.
	 * 
	 * @param directiveEndOffset The include directive end offset, a non-negative
	 *                           integer.
	 */
