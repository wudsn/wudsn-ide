...
public abstract class CompilerProcessLogParser {
	...
	public static final class Marker {
		...
		public boolean equals(Object o) {
			...
			return iFile.getFullPath().equals(other.iFile.getFullPath()) && lineNumber == other.lineNumber
					&& severity == other.severity && message.equals(other.message)
					&& ((detailMarker == null && other.detailMarker == null)
							|| detailMarker.equals(other.detailMarker));
	 ...
	 * 
	 * @param list The modifiable list to which the compiler symbols shall be added,
	 *             not <code>null</code>.
	 * 
	 * @throws CoreException if the symbols information is present, but cannot be
	 *                       read or parsed.
	 */
		...
		if (normalizedFilePath.length() > 0 && !normalizedFilePath.equals(normalizedMainSourceFilePath)) {
			...
			if (iFile == null || !iFile.exists()) {
				...
				if (iFile != null && caseInsenstiveIFile != null) {
					...
					message += " " + TextUtility.format(Texts.MESSAGE_S143, filePath,
