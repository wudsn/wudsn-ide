...
final class AssemblerEditorToggleCommentAction extends TextEditorAction {
	...
	/**
	 * Checks, if the selection in the given document is commented fully using one
	 * of the single line comment delimiters.
	 * 
	 * @param document  The document, not <code>null</code>.
	 * @param selection The selection, not <code>null</code>.
	 * 
	 ...
	 * delimiters.
	 * 
	 * @param lineText The line text, may be empty, not <code>null</code>.
	 * 
	 * @return <code>true</code>, if commented.
	 */
