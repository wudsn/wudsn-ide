...
public final class MarkerUtility {
	 ...
	 * 
	 * @param file       The {@link IFile} resource to which this message shall be
	 *                   attached, not <code>null</code>.
	 * @param lineNumber An positive integer value indicating the line number for a
	 ...
	 * 
	 * @param editor The editor part to start from, not <code>null</code>. If
	 *               required an additional editor will be opened in the same
	 *               workbench page.
	 * 
	 * @param marker The marker, not <code>null</code>. The resource of the marker
