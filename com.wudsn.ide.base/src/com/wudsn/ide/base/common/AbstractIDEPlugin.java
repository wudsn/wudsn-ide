...
public abstract class AbstractIDEPlugin extends AbstractUIPlugin {
	 ...
	 * @param parameters The message parameters, may be empty or <code>null</code>.
	 */
...
//	System.out.println(message);
	 ...
	 * @param message    The message, not <code>null</code>.
	 * @param parameters The message parameters, may be empty or <code>null</code>.
	 * @param th         The throwable or <code>null</code>.
	 */
	 ...
	 * 
	 * @param message The message, not <code>null</code>.
	 * @param th      The throwable, not <code>null</code>.
	 */
	 ...
	 * 
	 * @param path The plug-in relative path, not <code>null</code>.
	 * 
	 ...
	 * @param path The plug-in relative path, not <code>null</code>.
	 * 
	 * @return The image descriptor or <code>null</code> if no image resource was
	 *         found.
	 */
	 ...
	 * 
	 * @param fileName The name of a file or directory, no compound name like
	 *                 "dir1\dir2" or "dir1\file1", not <code>null</code>.
	 * 
	 * @return The absolute path of the file or directory in the plugin's directory,
