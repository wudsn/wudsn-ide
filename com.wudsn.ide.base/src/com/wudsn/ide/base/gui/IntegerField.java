...
public final class IntegerField extends Field {
	 ...
	 * @param defaultValues The array of default values or <code>null</code>.
	 * @param digitLength   The minimum digit length, see {@link NumberUtility} and
	 *                      {@link HexUtility}.
	 * @param hexMode       <code>true</code> if display and value help shall be in
	 *                      hex mode
